...
\[= \exp\left(- \frac{\gamma_i^2}{2}\left(\frac{1}{\xi^2} + \frac{\Xi\left(\sum_{t=2}^T \alpha_{t-1}^T\right)}{\delta^2}\right) + \gamma_i \left(\frac{\eta}{\xi^2} + \frac{\left(\sum_{t=1}^T \alpha_{t-1}^T\right)^T \left(\sum_{t=2}^T \alpha_{it}\right)}{\delta^2}\right) - \left(\frac{\eta^T \eta}{2\xi^2} + \frac{\Xi\left(\sum_{t=2}^T \alpha_{it}\right)}{2 \delta^2}\right)\right)\]
